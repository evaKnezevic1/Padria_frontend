...
interface HomeAboutSectionProps {
  initialAboutData: AboutContentResponse | null;
}

export default function HomeAboutSection({ initialAboutData }: HomeAboutSectionProps) {
  const { language } = useLanguage();
  const [aboutData, setAboutData] = useState<AboutContentResponse | null>(initialAboutData);
